...
$sql = "UPDATE tbl_questions SET ques_type='$questype',question='$question', option1='$opt1', option2='$opt2', option3='$opt3', option4='$opt4', answer='$answer' WHERE question_id='$question_id'";
...
$sql = "UPDATE tbl_questions SET ques_type='$questype',question='$question', answer='$answer' WHERE question_id='$question_id'";
