        ...
        <main class="page-content content-wrap">
            <div class="navbar">
                <div class="navbar-inner">
                    ...
                    <div class="logo-box">
                        <a href="./" class="logo-text"><span><img src="kashipara.png" alt="" height="50" width=""></span></a>
                    </div>
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
                                           ...
                                           if ($result->num_rows > 0) 
                                           {
                                            while($row = $result->fetch_assoc())
                                             {
                                                $sheet->setCellValue('B2', "Domain");
                                                $sheet->setCellValue('D2', $row['category']);
                                                $sheet->setCellValue('B3', "Skill");
                                                $sheet->setCellValue('D3', $row['subject']);
                                                $sheet->setCellValue('B4', "Total Questions");
                                                $sheet->setCellValue('D4', $row['tot_ques']);
                                                $sheet->setCellValue('B5', "Passmark %");
                                                $sheet->setCellValue('D5', $row['passmark']);
                                           ...
                                           if ($result->num_rows > 0) {
                                            ...
                                            $sheet->setCellValue('B7',"Student ID");
                                         
                                            $sheet->setCellValue('C7',"Score %");
                                        ...
                                        <tbody>';
                                           ...
                                           while($row = $result->fetch_assoc()) {
                                            ...
                                            $sheet->setCellValue('B'. $i, $row['student_id']);
                                          ...
                                          print '
                                           ...
                                           if (file_exists('results/'.$exam_name.'Results.xlsx')) {
                                                 unlink('results/'.$exam_name.'Results.xlsx');
                                         }
                                           $writer->save('results/'.$exam_name.'Results.xlsx');
										   print '
									   </tbody>
                                       </table>  ';
                                            } else {
