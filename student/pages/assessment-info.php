...
//$mail->SMTPSecure = fase;
//$mail->Port       = 25;

$mail->setFrom('assesment@7hillsts.com', '7hillsTS Admin');
$mail->addAddress($myemail , $myfullname);              
//$mail->addReplyTo('jobs@7hillsts.com', '7hillsTS Admin');
   
$mail->isHTML(true);                                 

$mail->Subject = '7hills TS Assesment Result for:'. $exam_name;
$mail->Body    = $message;
                            ...
                            <div class="panel panel-white">
                                ...
                                <div class="alert alert-success" role="alert">
                                    ...
                                    <div class="alert alert-success" role="alert">
                                        ...
                                        print '
                                        <div class="alert alert-success" role="alert">
                                        You have Rmoved out of assesment window page .
                                            </div>';								
                                        }
                                else {
																print '
